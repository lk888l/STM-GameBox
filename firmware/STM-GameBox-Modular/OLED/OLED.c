...
/*   恐龙游戏补丁_bin   */
void OLED_WriteData_bin(uint8_t Data)
{
	OLED_I2C_Start();
...
void OLED_ClearPicture(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	uint16_t i = 0;
	uint8_t  j = 0;
...
void OLED_ShowCloud(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	...
	for(i = 0; i < (y2 - y1 + 1); i++)
	{
		if(x1 > 100)
		{
			OLED_SetCursor((y1 + i), x1);
			for(j = 0; j < 127 - x1; j++)
				OLED_WriteData_bin(OLED_Cloud[i][j]);
		}
		if(x1 >= 0 && x1 <= 100)
		{
			OLED_SetCursor((y1 + i), x1);
...
//补丁显示恐龙
void OELD_ShowDino(int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint8_t Number)
{
	uint16_t i = 0;
	uint8_t  j = 0;
	...
	for(i = 0; i < (y2 - y1 + 1); i++)
	{
		OLED_SetCursor((y1 + i), x1);
		for(j = 0; j < (x2 - x1 + 1); j++)
			OLED_WriteData_bin(OLED_Dino[Number][i][j]);
	}
}
//补丁显示恐龙跳跃
void OELD_ShowDino_Jump(int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint8_t Number)
{
	uint16_t i = 0;
	uint8_t  j = 0;
	...
	for(i = 0; i < (y2 - y1 + 1); i++)
	{
		OLED_SetCursor((y1 + i), x1);
		for(j = 0; j < (x2 - x1 + 1); j++)
			OLED_WriteData_bin(OLED_Dino_Jump[Number][i][j]);
	}
}
//补丁显示仙人掌1
void OLED_ShowCactus1(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	...
	for(i = 0; i < (y2 - y1 + 1); i++)
	{
		if(x1 > 119)
		{
			OLED_SetCursor((y1 + i), x1);
			for(j = 0; j < 127 - x1; j++)
				OLED_WriteData_bin(OLED_Cactus1[i][j]);
		}
		if(x1 >= 0 && x1 <= 119)
		{
			OLED_SetCursor((y1 + i), x1);
...
void OLED_ShowCactus2(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	...
	for(i = 0; i < (y2 - y1 + 1); i++)
	{
		if(x1 > 111)
		{
			OLED_SetCursor((y1 + i), x1);
			for(j = 0; j < 127 - x1; j++)
				OLED_WriteData_bin(OLED_Cactus2[i][j]);
		}
		if(x1 >= 0 && x1 <= 111)
		{
			OLED_SetCursor((y1 + i), x1);
...
void OLED_ShowCactus3(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	...
	for(i = 0; i < (y2 - y1 + 1); i++)
	{
		if(x1 > 111)
		{
			OLED_SetCursor((y1 + i), x1);
			for(j = 0; j < 127 - x1; j++)
				OLED_WriteData_bin(OLED_Cactus3[i][j]);
		}
		if(x1 >= 0 && x1 <= 111)
		{
			OLED_SetCursor((y1 + i), x1);
